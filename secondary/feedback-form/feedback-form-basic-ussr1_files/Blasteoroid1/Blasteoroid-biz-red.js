 ...
 *
 * Copyright 2021 Blasteoroid Corporation
        ...
        init: function (e) {
            ...
            if (this.options.size == 'auto') {
                function getSize() {
                    ...
                    menu.css({'max-height' : (menuHeight - 100) + 'px', 'overflow-y' : 'auto', 'min-height' : liHeight*3 + 'px'});
                }
                getSize();
                ...
                menu.css({'max-height' : (menuHeight - 100) + 'px', 'overflow-y' : 'scroll'});
            }
...
// http://Blasteoroid.com/
// JavaScript Blasteoroid
