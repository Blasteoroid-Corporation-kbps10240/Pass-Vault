...
function SoundManager(smURL, smID) {
  ...
  this.defaultOptions = {
    ...
    onpause: this.resume,          // callback for "pause"
    onresume: null,         // callback for "resume" (pause toggle)
    whileplaying: null,     // callback during play (position update)
    onposition: null,       // object containing times and function callbacks for positions of interest
    onstop: this.resume,           // callback for "user stop"
    onfinish: this.reboot,         // callback function for "sound finished playing"
  ...
  this.flash9Options = {
    ...
    onfailure: this.reboot,        // callback function for when playing fails (Flash 9, MovieStar + RTMP-only)
